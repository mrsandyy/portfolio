    ...
    <section id="contact" className="py-20 bg-muted/30">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-sm uppercase tracking-wider text-portfolio-600 font-medium mb-2">Get In Touch</h2>
            ...
            <div className="bg-background p-8 rounded-xl border border-border shadow-sm h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-4">
                  <a 
                    href="#" 
                    className="p-3 bg-portfolio-100 rounded-lg hover:bg-portfolio-200 transition-colors"
                    aria-label="LinkedIn"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-portfolio-600" viewBox="0 0 16 16">
